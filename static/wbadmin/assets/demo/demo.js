  ...
  showSwal: function(type) {
    if (type == 'basic') {
      ...
      swal({
        ...
        buttonsStyling: false,
        confirmButtonClass: "btn btn-success",
        html: 'Использовать <b>жирный текст</b>, ' +
          '<a href="httpы://lms.kg">ссылку</a> ' +
          'и другие тэги'
      }).catch(swal.noop)

    } else if (type == 'auto-close') {
      swal({
        title: "Сообщение закроется автоматически!",
        text: "Я закроюсь через 2 секунды.",
        timer: 2000,
